...
tabtitle = 'xkcd'
list_of_options=['box plot', 'correlation', 'git commit', 'scatterplot', 'selection bias']
list_of_images=['outlier.png', 'correlation.png', 'gitcommit.jpg', 'scatterplot.png', 'selection_bias.png', 'good_code.png']
